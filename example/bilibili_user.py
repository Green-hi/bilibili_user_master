            ...
            if status_code == 0:
                ...
                try:
                    ...
                    conn = pymysql.connect(
                        host='localhost', user='root', passwd='328Hl2412', db='bilibili', charset='utf8')
                    cur = conn.cursor()
                    sql = "INSERT INTO bilibili_user_info (mid, name, sex, `rank`, face, regtime,birthday,\
                     sign, level, OfficialVerifyType, OfficialVerifyDesc, vipType, vipStatus,coins, following, fans)\
